...
const AddRacerFrom = ({ onAddRacer, disable = false }: AddRacerFormProps) => {
        ...
        <Card className="mx-auto max-w-md">
          ...
          <CardContent className="grid grid-cols-1 gap-3">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="name" className="text-black font-bold">
                    Name:
                  </FormLabel>
                  <FormControl>
                    <Input
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel htmlFor="colorTag" className="text-black font-bold">
                    Color Tag:
                  </FormLabel>
                  <FormControl>
